...
if ($_GET[module]=='produk'){
	    echo "<h3>Semua Produk no Faktur : $_GET[kode]<span style='float:right'><a style='float:right;' target='_BALNK' href='print-produk.php?kode=$_GET[kode]'>Cetak Laporan Produk</a></span></h3><br/>
          <input type=button value='Tambah Produk Baru' onclick=\"window.location.href='media.php?module=tambahproduk&no=$_GET[kode]';\">
    ...
    while($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr class='data'><td class='data'>$no</td>
				...
				<td class='data' align=center>$r[jumlah] </td>
...
echo "<h3>Tambah Produk Baru : $_GET[no]</h3><br/>
    ...
    echo "</select></td></tr>
          <tr><td>Harga Satuan</td>     <td> : <input type=text name='harga' size=20></td></tr>
		  
		  
		  <tr><td>Nama Satuan</td>     <td> : <input type=text name='satuan' size=20></td></tr>
